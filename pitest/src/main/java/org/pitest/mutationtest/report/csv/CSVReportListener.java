        ...
        try {
            ...
            for (final MutationResult mutation : metaData.getMutations()) {
                this.out.write(makeCsv(mutation.getDetails().getFilename(),
                                ...
                                mutation.getDetails().getClassName().getNameWithoutPackage().asJavaName() +
                                        "_" +
                                        mutation.getDetails().getId().getLocation().getMethodName().name() +
                                        "_" +
                                        mutation.getDetails().getId().getFirstIndex() +
                                        ".class")
